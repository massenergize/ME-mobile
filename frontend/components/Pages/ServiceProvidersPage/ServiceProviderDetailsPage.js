        ...
        <Box backgroundColor="white" px="5" pt="5" borderTopRadius="2xl">
          ...
          <Box mb="5">
            ...
            <Text fontSize="md">
              ...
              choosing an EV easier for you. Anyone is eligible to participate
              and receive a discount to purchase or lease a top EV model at a
              participating dealer. DriveGreen is a program of the Green Energy
              Consumers Alliance, non-profit organization that has been
              succeeding in making energy more affordable and environmentally
              sustainable since 1982. Green Energy serves as a trusted voice for
              both consumers and the environment on local, state, regional and
              national energy issues. Their goal is to reduce emissions 80% by
              2050 and stop climate change. EVs are a big part of the solution!
            </Text>
          </Box>
          <Box mb="5">
            <Text fontSize="lg" fontWeight="bold">
